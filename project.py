...
def getWeather(city_name):
    cityName = takeCommand()    # getting input of name of the place from user
    ...
    if x["cod"] != "404":
        ...
        humidity = y["humidity"]
        desc = x["weather"]
        # Assuming z is a list of dictionaries containing weather information
        if z:
            description = z[0]["description"]
            # Use description variable in further processing
        else:
